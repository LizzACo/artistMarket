     ...
     <meta charSet="UTF-8" />
        ...
        <main className="artist-container">
          ...
          <div className="artist-container-row">
            ...
            <img className="no-image-box-2" src="img/collection1880.png" />
            ...
            <div className="artists">
              {/* <div className="no-image-box-2" /> */}
            <img className="no-image-box-2" src="img/event4.png" />
              <dl>
                <dt>Aino Aalto</dt>
                <dt>Fininish,</dt>
                <dt>1894-1949</dt>
            ...
            <img className="no-image-box-2" src="img/afe.png" />
              <dl>
                <dt>Aino Aalto</dt>
                <dt>Fininish,</dt>
                <dt>1894-1949</dt>
            ...
            <div className="artists">
              {/* <div className="no-image-box-2" /> */}
            <img className="no-image-box-2" src="img/wis.png" />
              <dl>
                <dt>Aino Aalto</dt>
                <dt>Fininish,</dt>
                <dt>1894-1949</dt>
          ...
          <div className="artist-container-row">
            <div className="artists">
              {/* <div className="no-image-box-2" /> */}
            <img className="no-image-box-2" src="img/takashi2.png" />
              <dl>
                <dt>Aino Aalto</dt>
                <dt>Fininish,</dt>
                <dt>1894-1949</dt>
            ...
            <div className="artists">
              {/* <div className="no-image-box-2" /> */}
            <img className="no-image-box-2" src="img/takashi3.png" />
              <dl>
                <dt>Aino Aalto</dt>
                <dt>Fininish,</dt>
                <dt>1894-1949</dt>
            ...
            <div className="artists">
              {/* <div className="no-image-box" /> */}
            <img className="no-image-box-2" src="img/monet2.png" />
              <dl>
                <dt>Aino Aalto</dt>
                <dt>Fininish,</dt>
                <dt>1894-1949</dt>
            ...
            <div className="artists">
              {/* <div className="no-image-box-2" /> */}
            <img className="no-image-box-2" src="img/monet3.png" />
