        ...
        <div>
            ...
            <div id="list-item-1" className="featured-wrap">
                ...
                <div className="artists">
                    <img className="box" src="img/afe.png" alt="artworks"/>
                    <h3><a href="{}">After Effect</a></h3>
                    <p>James Turrell</p>
                </div>
                <div className="artists">
                <img className="box" src="img/wis.png" alt="artworks"/>
                    <h3><a href="{}">What I Saw</a></h3>
                    <p>Joseph E. Yoakum</p>
                </div>
                <div className="artists">
                <img className="box" src="img/collection1880.png" alt="artworks"/>
            ...
            <div className="events-wrap">
                ...
                <div className="col-sm-6">
                    ...
                    <img className="events-box1" src="img/event1.png" alt="art news"/>
                ...
                <div className="col-sm-6">
                    <div className="events">
                    <img className="events-box1" src="img/event.png" alt="art news"/>
                    ...
                    <div className="col-sm-6">
                        ...
                        <img className="events-box1" src="img/event3.png" alt="art news"/>
                    ...
                    <div className="col-sm-6">
                        <div className="events events2">
                        <img className="events-box1" src="img/event4.png" alt="art news"/>
            ...
            <div className="trending-wrap">
                ...
                <div className="artists">
                <img className="box" src="img/artist1.png" alt="trending artists"/>
                    <h3><a href="{}">Cha Yuree</a></h3>
                    <p>American</p>
                </div>
                <div className="artists">
                <img className="box" src="img/artist2.png" alt="trending artists"/>
                    <h3><a href="{}">Kim Hyung Dae</a></h3>
                    <p>Korean</p>
                </div>
                <div className="artists">
                <img className="box" src="img/artist3.png" alt="trending artists"/>
                    <h3><a href="{}">Agathe Pitié</a></h3>
                    <p>French</p>
                </div>
                <div className="artists">
                <img className="box" src="img/artist4.png" alt="trending artists"/>
                    <h3><a href="{}">Victoria Tanto</a></h3>
                    <p>French</p>
                </div>
                <div className="artists">
                <img className="box" src="img/artist5.png" alt="trending artists"/>
                    <h3><a href="{}">Mónica de Miranda</a></h3>
                    <p>Afro-Portuguese</p>
                </div>
                <div className="artists">
                <img className="box" src="img/artist6.png" alt="trending artists"/>
                    <h3><a href="{}">Charles Irvin</a></h3>
                    <p>American</p>
                </div>
                <div className="artists">
                <img className="box" src="img/artist7.png" alt="trending artists"/>
                    <h3><a href="{}">David Price</a></h3>
                    <p>British</p>
                </div>
                <div className="artists">
                <img className="box" src="img/artist8.png" alt="trending artists"/>
                    <h3><a href="{}">Alice Wheeler</a></h3>
                    <p>American</p>
                </div>
                <div className="artists">
                <img className="box" src="img/artist9.png" alt="trending artists"/>
                    <h3><a href="{}">Yangyang Pan</a></h3>
                    <p>Chinese</p>
                </div>
                <div className="artists">
                <img className="box" src="img/artist10.png" alt="trending artists"/>
                    <h3><a href="{}">Pablo Dávila</a></h3>
                    <p>Mexican</p>
                </div>
                <div className="artists">
                <img className="box" src="img/artist11.png" alt="trending artists"/>
                    <h3><a href="{}">Klaus Killisch</a></h3>
                    <p>German</p>
                </div>
                <div className="artists">
                <img className="box" src="img/artist12.png" alt="trending artists"/>
